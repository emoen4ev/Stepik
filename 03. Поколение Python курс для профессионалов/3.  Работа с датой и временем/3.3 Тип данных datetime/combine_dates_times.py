...
data_datatime = [datetime.combine(dates[i], times[i]) for i in range(len(dates))]

sorted_by_seconds = sorted(data_datatime, key=lambda s: s.second)

result = '\n'.join(str(el) for el in sorted_by_seconds)
